...
// IR:   call void @tiled_matmul_auto(i64 128, i64 256, i64 128, ptr %0, ptr %1, ptr null, ptr %2, i64 128, i64 256, i64 256, i64 256,
//                                   A_scale B_scale D_scale act  scale  bert_scale rep_bias trA trB full_C low_D weightA type(OS)
// IR-SAME:                          float 1.000000e+00, float 1.000000e+00, i32 1, i32 0, float 1.000000e+00, float 1.000000e+00, i1 false, i1 false, i1 false, i1 true, i1 false, i8 0, i32 0)
