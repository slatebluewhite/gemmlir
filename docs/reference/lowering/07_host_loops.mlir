module attributes {torch.debug_module_name = "Block"} {
  ...
  memref.global "private" constant @__constant_16xi32 : memref<16xi32> = dense<[-1379, -2202, 1304, -2244, 2450, 5210, -5263, 1106, -3975, -6599, -5225, -7063, -1256, 12331, -5055, -496]> {alignment = 64 : i64}
  ...
  func.func @forward(%arg0: memref<1x8x16x16xf32>) -> memref<1x16x8x8xf32> {
    ...
    %cst = arith.constant 31.0435772 : f32
    ...
    %cst_3 = arith.constant 1.82484782E-5 : f32
  ...
  ^bb44:  // pred: ^bb1
    ...
    gemmlir.conv2d_i8(%view, %2, %view_4) bias(%1 : memref<16xi32>) {act = #gemmlir.act<relu>, gemmlir.no_flush_after, padding = 1 : i64, scale = 0.00203614822 : f32} : (memref<1x16x16x8xi8>, memref<3x3x8x16xi8>, memref<1x16x16x16xi8>)
