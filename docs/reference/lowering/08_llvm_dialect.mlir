module attributes {llvm.data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", llvm.target_triple = "riscv64-unknown-linux-gnu", torch.debug_module_name = "Block"} {
  ...
  llvm.mlir.global private constant @__constant_16xi32(dense<[-1379, -2202, 1304, -2244, 2450, 5210, -5263, 1106, -3975, -6599, -5225, -7063, -1256, 12331, -5055, -496]> : tensor<16xi32>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<16 x i32>
  ...
  llvm.func @forward(%arg0: !llvm.ptr) -> !llvm.ptr {
    ...
    %16 = llvm.mlir.constant(0.00203614822 : f32) : f32
    ...
    %33 = llvm.mlir.constant(1.82484782E-5 : f32) : f32
    %34 = llvm.mlir.constant(0.0206788406 : f32) : f32
    ...
    %39 = llvm.mlir.constant(31.0435772 : f32) : f32
