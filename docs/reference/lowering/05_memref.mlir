...
module attributes {torch.debug_module_name = "Block"} {
  ...
  func.func @forward(%arg0: memref<1x8x16x16xf32>) -> memref<1x16x8x8xf32> {
    ...
    %cst_1 = arith.constant 0.0286696423 : f32
    %c-128_i32 = arith.constant -128 : i32
    %c127_i32 = arith.constant 127 : i32
    %cst_2 = arith.constant 3.74739611E-5 : f32
    %cst_3 = arith.constant 0.024088297 : f32
    %cst_4 = arith.constant 2.12572231E-5 : f32
    ...
    linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : vector<2xi64>, gemmlir.output_scale = 0.024088296360000001 : f64, strides = dense<1> : vector<2xi64>} ins(%alloc_6, %2 : memref<1x18x18x8xi8>, memref<3x3x8x16xi8>) outs(%alloc_7 : memref<1x16x16x16xi32>)
